...
import com.unsky.myblog.service.*;
...
public class AdminController {
    ...
    public String login(@RequestParam("userName") String userName,
                        ...
                        HttpSession session){
        String key =  "login_valid_code_" + session.getId();
        if (redisUtil.getExpire(key) < 0L){
            session.setAttribute("errorMsg","验证码过期");
            return "admin/login";
        }
